        ...
        try:
            if isinstance(track_id, str):
                ...
                if match:
                    ...
                    raise ValidationError(f"Could not extract track number from '{track_id}'. Use format like '1' or 'track 1'")
            ...
            for param_name, validator_func in validators.items():
                if param_name in bound_args.arguments:
                    try:
                        ...
                        raise ValidationError(f"Invalid parameter '{param_name}': {str(e)}") from e
