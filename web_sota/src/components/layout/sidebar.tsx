...
export function Sidebar({ collapsed, onToggle }: SidebarProps) {
    ...
    const navItems = [
        ...
        { href: '/transport', label: 'Transport', icon: Activity },
        { href: '/tracks', label: 'Tracks', icon: List },
        { href: '/mixer', label: 'Mixer', icon: Sliders },
        ...
        >
            <div className="flex h-16 items-center border-b border-slate-800 px-4">
                <div className="flex items-center gap-2 font-semibold text-slate-100">
                    ...
                    {!collapsed && <span className="animate-in fade-in duration-300 font-mono tracking-tighter">REAPER-MCP</span>}
                </div>
            </div>
