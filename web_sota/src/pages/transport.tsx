...
import { Activity, Play, Square, Pause, Circle } from "lucide-react";
        ...
        <div className="space-y-6">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground italic text-sm">
                    Austrian Precision Playback Orchestration
                </p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <Card className="col-span-2">
                    ...
                    <CardContent className="flex flex-col items-center gap-8 py-10">
                        <div className="text-6xl font-mono font-bold tracking-tighter text-red-500">
                            14.2.00
                        </div>
                        <div className="flex gap-4">
                            <Button size="icon" variant="outline" className="h-16 w-16 rounded-full border-slate-800 hover:bg-slate-800">
                                <Square className="h-8 w-8 text-white fill-white" />
                            </Button>
                            <Button size="icon" variant="outline" className="h-16 w-16 rounded-full border-slate-800 bg-red-500/10 hover:bg-red-500/20">
                                <Play className="h-8 w-8 text-red-500 fill-red-500" />
                            </Button>
                            <Button size="icon" variant="outline" className="h-16 w-16 rounded-full border-slate-800 hover:bg-slate-800">
                                <Pause className="h-8 w-8 text-white fill-white" />
                            </Button>
                            <Button size="icon" variant="outline" className="h-16 w-16 rounded-full border-slate-800 bg-red-900/20 hover:bg-red-900/30">
