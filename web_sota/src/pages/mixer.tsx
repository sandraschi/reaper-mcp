...
import { Sliders, Volume2, VolumeX, Radio } from "lucide-react";
...
function FaderStrip({ id, name, isMaster }: TrackProps) {
    ...
    return (
        <div className={cn(
            ...
            <div className="text-[12px] font-mono text-emerald-500 mt-2">
                {Math.round((volume[0] / 100) * 12 - 12)} dB
            </div>
