import { Activity, AlertCircle, Link as LinkIcon, Power, Server } from "lucide-react";
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Badge
                ...
                className={isConnected ? "bg-emerald-500/10 text-emerald-500" : "bg-amber-500/10 text-amber-500"}
              >
            ...
            {!isConnected && (
              <div className="pt-2">
                ...
                <p className="text-xs text-muted-foreground mt-2 text-center">Targeting default installation paths</p>
              </div>
            )}
          </CardContent>
        </Card>
