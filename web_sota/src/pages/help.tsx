...
import { Book, Server, Code, Terminal, ExternalLink } from 'lucide-react';
                        ...
                        <div className="space-y-6">
                            <Card>
                                ...
                                <CardContent className="space-y-4 text-slate-300">
                                    <p>Welcome to the <strong>Reaper MCP Neural Interface</strong>. This application allows AI agents and humans to interact with Reaper DAW through a unified protocol.</p>

                                    <h3 className="text-lg font-semibold text-white mt-4">Key Features</h3>
                                    <ul className="list-disc list-inside space-y-2 ml-2">
                                        <li><strong>Tools Hub:</strong> Browse and execute available MCP tools manually.</li>
                                        <li><strong>ReaScript IDE:</strong> Write and run Python scripts directly inside Reaper.</li>
                                        <li><strong>Status Monitor:</strong> Check connection health and start Reaper remotely.</li>
                                    </ul>
                                </CardContent>
                            </Card>

                            <Card>
                                <CardHeader><CardTitle>Common Workflows</CardTitle></CardHeader>
                                <CardContent className="space-y-4 text-slate-300">
                                    <div className="border-l-2 border-slate-700 pl-4">
                                        <h4 className="font-semibold text-white">1. Starting Up</h4>
                                        <p>Ensure `start.ps1` or `start.bat` is running. Check the <strong>Status</strong> page to verify Reaper connection.</p>
                                    </div>
                                    <div className="border-l-2 border-slate-700 pl-4">
                                        <h4 className="font-semibold text-white">2. Using Tools</h4>
                                        <p>Navigate to <strong>Tools</strong>. Select `reaper_transport` to control playback or `reaper_tracks` to manage tracks. Inputs are JSON-formatted.</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </div>
