...
4. Start the server:
   ...
   uv run uvicorn reaper_mcp.server:app --port 10797
   ```
5. Open `http://localhost:10797` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/reaper-mcp/issues) |
